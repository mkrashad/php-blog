            ...
            <table>
                ...
                <!--Подключаем левый блок сайта-->
                  <?php include("blocks/lefttd.php"); ?>
                    ...
                    if(isset($title) && isset($meta_d) && isset($meta_k) && isset($mytext) && isset($id)){

                        //Здесь пишем что можно заносить информацию в базу
                        $result = mysql_query("UPDATE settings SET title='$title',meta_d='$meta_d',meta_k='$meta_k',mytext='$mytext' WHERE id='$id'");
